...
export const spacesCdnEndpoint = process.env.NEXT_PUBLIC_SPACES_CDN_ENDPOINT;
...
export const leagueOfItems = process.env.NEXT_PUBLIC_LEAGUE_OF_ITEMS;
export const slackWebhookUrl = process.env.NEXT_PUBLIC_SLACK_WEBHOOK_URL;
